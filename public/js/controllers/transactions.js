...
angular.module('VTS.transactions').controller('TransactionController', ['$scope', '$routeParams', '$location', 'Global', 'TransactionsIn', 'TransactionsOut', 'Color', 'Thickness', 'Width', 'Warehouse', 'RollSize', '_',
    function($scope, $routeParams, $location, Global, TransactionsIn, TransactionsOut, Color, Thickness, Width, Warehouse, RollSize, _) {
        ...
        $scope.findAll = function() {
            var statusList = [{
                displayText: 'Draft Only',
                code: 'DRAFT'
            }, {
                displayText: 'Approved Only',
                code: 'APPROVED'
            }, {
                displayText: 'All Entries',
                code: 'ALL'
            }];
